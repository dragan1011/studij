...
export const Dokumenti = (props) => {
  ...
  return (
    <div
      ...
      key={props.id}
    >
      <div className={`${classes.cell} ${classes.naziv}`} onClick={openDokumentiModal} >{props.oznaka}</div>
      <div className={`${classes.cell} ${classes.naziv}`} onClick={openDokumentiModal}>{props.datum}</div>
      <div className={`${classes.cell} ${classes.naziv}`} onClick={openDokumentiModal}>{props.napomena}</div>
      <div className={`${classes.cell} ${classes.naziv}`} onClick={openDokumentiModal}>
