...
const ModalOverlay = (props) => {
  ...
  <CentriTabela centarId={props.centarId} centar={centar} closeModal={() => {props.closeModal(false)}} studijId={props.data.id}    /* refresh={refreshFunc}   */ data={props.centri}  /> 
  ...
  return (
    <Fragment>
      {ReactDOM.createPortal(
        <ModalOverlay centarId={props.centarId} showCentar={props.showCentar} centri={props.centri} data={props.data} closeModal={props.closeModal} title={props.title}>{props.children}</ModalOverlay>,
        portalElement
      )}
    </Fragment>
  );
