...
<div className={classes.menuLook}>
    <TopMenuButton name={'Dokumenti'} activ={active} select={setSelectedHandler}><div className={classes.ispravljenje}>Dokumenti</div></TopMenuButton>
    <TopMenuButton name={'Lijek'} activ={active} select={setSelectedHandler}><div className={classes.ispravljenje}>Lijek</div></TopMenuButton>

</div>
{active === 'Dokumenti' && <Dokumenti studijId={props.studijId} />}
