 ...
 const searchUserFunc = (data) => {
  ...
  return (
    <div>
     ...
     <button  onClick={modal}  className={classes.add}>Dodaj novu seriju</button>
     { isModal && <AddDokumentiDetaljiModal data={props.data}  refresh={refreshFunc}  closeModal={setIsModal} title="Dodaj novu seriju" />}
        </div> 
    ...
    <div className={`${classes.heading} ${classes.half}`}>Jedinstveni kod lijeka</div>
